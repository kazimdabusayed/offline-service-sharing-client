...
const Login = () => {
    ...
    return (
		<section className="w-screen p-4 dark:bg-gray-800 dark:text-gray-100">
			<div className="container grid gap-6 mx-auto text-center lg:grid-cols-2 xl:grid-cols-5">
				<div className="px-6 py-16 rounded-md sm:px-12 md:px-16 xl:col-span-2 dark:bg-gray-900">
					...
					<p className="my-8">
						...
						Fugit vero facilis dolor sit neque cupiditate minus esse
						accusamus cumque at.
					</p>
					<form
						novalidate=""
